...
The maximum amount of points that can be achieved for an individual event is **36.5 points**. 

The maximum amount of points that can be achieved for a relay event is **18.25 points**.

*These rules are subject to change, but an official notice will be released to all users several days prior to the change.*
